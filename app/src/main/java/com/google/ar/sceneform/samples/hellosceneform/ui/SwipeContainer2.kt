...
class SwipeContainer2(
    ...
    private lateinit var behavior: BottomSheetBehavior<SwipeContainer2ContentView>
    private val contentView = SwipeContainer2ContentView(context)
